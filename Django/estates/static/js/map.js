...
function home() {
    ...
    var mapContainer = document.getElementById("map"), // 지도를 표시할 div
        mapOption = {
            center: new kakao.maps.LatLng(37.566826, 126.8786567), // 지도의 중심좌표
            level: 9, // 지도의 확대 레벨
        };
            ...
            $.ajax({
                ...
                success: function (jsonData) {
                    $.each(jsonData, function (index, item) {
                        ...
                        var show_mam = document.getElementById('show_mamul');
                        show_mam.addEventListener('click', function () {
                            clusterer_index.addMarkers(markers);
                            clusterer_index.setMap(map);
                            $('#show_mamul').hide();
                            $('#hide_mamul').show();
                        })
                        var hide_mam = document.getElementById('hide_mamul');
                        hide_mam.addEventListener('click', function () {
                            clusterer_index.clear();
                            $('#hide_mamul').hide();
                            $('#show_mamul').show();
                            $('#sidebar').hide();
                            $('#facilities').hide();
